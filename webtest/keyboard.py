...
class Keyboard:
    ...
    # Research link: https://msdn.microsoft.com/en-us/library/windows/desktop/dd375731(v=vs.85).aspx https://docs.microsoft.com/en-us/windows/win32/inputdev/virtual-key-codes#requirements
    VK_BACKSPACE = 0x08
    VK_ENTER = 0x0D
    VK_CTRL = 0x11
    VK_ALT = 0x12
